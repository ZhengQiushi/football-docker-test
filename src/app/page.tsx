              ...
              <form className="bg-slate-50 p-12 rounded-[3rem] border border-slate-200 shadow-2xl space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-white border border-slate-200 px-6 py-4 rounded-2xl outline-none focus:border-athletic-orange transition-colors" placeholder="您们的姓名" required />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea className="w-full bg-white border border-slate-200 px-6 py-4 rounded-2xl outline-none focus:border-athletic-orange transition-colors h-32 resize-none" placeholder="告诉我们更多关于您们的橄榄球背景..." />
                </div>
